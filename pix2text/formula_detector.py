# coding: utf-8
# Pix2Text: an Open-Source Alternative to Mathpix.
# Copyright (C) 2022-2024, Breezedeus.
...
def find_files(directory, extension):
    ...
    outs = []
    # Recursively find matching files using the rglob method
    for file_path in dir_path.rglob(pattern):
        # Check if the filename does not start with a dot (except for the file extension)
