...
class ElementType(Enum):
    ABANDONED = -2  # You can specify areas that are not recognized, such as the middle ground between Image and Image caption
    IGNORED = -1
    UNKNOWN = 0
    TEXT = 1
    TITLE = 2
...
class LayoutParser(object):
    def __init__(
        self,
        model_type: str = 'yolov7_tiny',  # Only 'yolov7_tiny' is currently supported.
        model_backend: str = 'pytorch',  # Only 'pytorch' is currently supported.
        device: str = None,
        **kwargs
    ):
