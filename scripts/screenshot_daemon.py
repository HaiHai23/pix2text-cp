...
thresholds = {
    'formula2general': 0.65,  # If the 'formula' type is recognized, but the score is less than this threshold, the 'general' type is changed instead
    'english2general': 0.75,  # If the 'English' type is recognized, but the score is less than this threshold, change to the 'General' type
}
